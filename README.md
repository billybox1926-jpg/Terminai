...
- optional Gemini-backed command optimization.
...
| `GEMINI_API_KEY` | Only for AI optimizer | Enables Gemini-backed command optimization. |
...
1. make the dashboard identity fully TerminAI end-to-end,
2. add CI for type-checking and production builds,
