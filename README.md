...
* ship a curated bootstrap package set,
...
`git curl wget jq tmux sqlite3 python3 nodejs npm gcc build-essential make ripgrep htop nano openssh java-common unzip zip tar`
