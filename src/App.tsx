...
type WorkspaceTab = "terminal" | "ai-copilot" | "scripts" | "settings";
    ...
    setSessions([
      {
        ...
        lines: [
          ...
          createLine(
            "info",
            "AI-assisted shell, workspace files, telemetry, scripts, and editor tools are mounted. Type commands directly or ask the optimizer for a safer plan.",
          ),
        ],
      },
    ]);
    ...
    <div id="terminai-workspace-root" className="min-h-screen bg-[#0A0A0B] text-[#E0E0E0] flex flex-col font-sans select-none antialiased">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-display font-black text-sm tracking-tight text-white uppercase flex items-center gap-1.5">
              TerminAI <span className="text-[10px] text-emerald-400 bg-emerald-950/40 px-1.5 py-0.5 border border-emerald-900 rounded lowercase font-mono">local_shell</span>
            </span>
      ...
      <footer className="bg-[#121214] border-t border-white/5 p-3 text-center text-xs font-mono text-white/40 shrink-0">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-1 max-w-7xl mx-auto w-full px-2">
          ...
          <span className="text-[10px] text-white/30">Local-first shell environment</span>
        </div>
      </footer>
    </div>
  );
